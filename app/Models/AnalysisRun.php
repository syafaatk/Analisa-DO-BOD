...
class AnalysisRun extends Model
{
 ...
 protected $fillable=['laboratory_id','sample_code','parameter','method_version','analyst','analysed_at','inputs','calculation','uncertainty','notes','status','approved_by','approved_at','sample_matrix','batch_code','instrument_code','reagent_lot','report_number','submitted_at'];
