...
class AnalysisController extends Controller
{
 ...
 public function calculateDo(Request $request){
  $data=$request->validate(['client_id'=>'nullable|uuid','sample_code'=>'required|string|max:100','simplo_titrasi_1'=>'required|numeric|min:0.000001','simplo_titrasi_2'=>'required|numeric|min:0.000001','duplo_titrasi_1'=>'required|numeric|min:0.000001','duplo_titrasi_2'=>'required|numeric|min:0.000001','normality'=>'required|numeric|min:0.000001','winkler_volume_ml'=>'required|numeric|min:2.000001','reagent_mnso4_ml'=>'required|numeric|min:0','reagent_alkali_ml'=>'required|numeric|min:0','aliquot_ml'=>'required|numeric|min:0.000001']);
   $this->assertClient($data['client_id']??null); $calc=$this->calc->dissolvedOxygenDuo($data['simplo_titrasi_1'],$data['simplo_titrasi_2'],$data['duplo_titrasi_1'],$data['duplo_titrasi_2'],$data['normality'],$data['winkler_volume_ml'],$data['reagent_mnso4_ml'],$data['reagent_alkali_ml'],$data['aliquot_ml']);
