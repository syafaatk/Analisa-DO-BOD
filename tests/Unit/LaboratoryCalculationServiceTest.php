...
class LaboratoryCalculationServiceTest extends TestCase{
 public function test_do_formula():void{$r=(new LaboratoryCalculationService)->dissolvedOxygen(1.2,1.2,0.025,300,1,1,50);$this->assertEqualsWithDelta(4.832214765,$r['result'],0.000001);}
 public function test_do_duo_structure():void{$c=(new LaboratoryCalculationService)->dissolvedOxygenDuo(1.2,1.2,1.3,1.3,0.025,300,1,1,50);$this->assertArrayHasKey('simplo',$c);$this->assertArrayHasKey('duplo',$c);$this->assertArrayHasKey('last_result',$c);$this->assertEqualsWithDelta(($c['simplo']['simplo_result']+$c['duplo']['duplo_result'])/2,$c['last_result'],0.000001);$this->assertContains($c['qc_status'],['PASS','REVIEW']);}
